    ...
    <section>
        <Element name="features">
            <div className="container">
                ...
                max-md:flex-col feature-after md:g7 max-md:border-none max-md:rounded-none mx-md:gap-3">
                    {features.map(({ id, icon, caption, title, text, button }) => (
                        ...
                        >
                            ...
                            <h2 className="max-w-400 mb-7 h3 test-p4 max-md:mb-6 max-md:h5">
                                {title}
                            </h2>
                    ...
                    <ul className="relative flex justify-around flex-glow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden
                    w-full">
                        ...
                        {details.map(({ id, icon, title }) => (
                            <li key={id} className="relative pt-16 px-4 pb-14">
                                ...
                                <div className="flex items-center justify-center mx-auto mb-3 border-2 rounded-full hover:border-s4
